...
import { ArrowUpRight, Check, Download, MessageCircle, SlidersHorizontal } from "lucide-react";
        ...
        <div className="grid items-end gap-8 lg:grid-cols-[1fr_auto]">
          <div className="max-w-3xl">
            ...
            <h2 className="text-[clamp(2rem,4vw,3.35rem)] font-extrabold leading-[1.04] tracking-[-0.045em]">
              One all-inclusive Baraat, built entirely around you.
            </h2>
            <p className="mt-5 max-w-2xl text-sm leading-7 text-[#010101]/56 sm:text-base">
              Start with the essentials, then choose the selectable experiences that make it entirely yours. Clearly explained, and personalized around your venue, route and guest count.
            </p>
          </div>
          <a
            href={pkg.pdfUrl}
        ...
        <div className="mt-12">
          <Reveal>
            <article className={`group overflow-hidden rounded-2xl border bg-white ${pkg.featured ? "border-[#E30B1D]/35 shadow-[0_30px_80px_-65px_rgba(227,11,29,0.85)]" : "border-[#010101]/10"}`}>
              ...
              <Link href="/packages" className="relative block min-h-[27rem] overflow-hidden bg-[#100104] sm:min-h-[31rem] lg:min-h-full">
                <Image
                  src={pkg.image}
                  alt={pkg.imageAlt}
                  fill
              ...
              <div className="flex flex-col p-6 sm:p-8 lg:p-10 xl:p-12">
                ...
                <div className="mt-9 grid gap-3 border-t border-[#010101]/10 pt-6 sm:grid-cols-[1fr_auto] sm:items-center">
                  <p className="inline-flex items-center gap-2 text-xs font-bold text-[#010101]/48"><SlidersHorizontal className="h-4 w-4 text-[#E30B1D]" aria-hidden="true" />Selectable experiences let you personalize it.</p>
                  <div className="flex flex-col gap-2 sm:flex-row">
                  <Link href="/packages" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-[#010101]/12 px-4 text-xs font-extrabold transition-colors hover:border-[#E30B1D] hover:text-[#E30B1D]">Full details <ArrowUpRight className="h-3.5 w-3.5" aria-hidden="true" /></Link>
                  <a
