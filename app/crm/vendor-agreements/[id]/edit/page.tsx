  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-6">
        {agreement ? <VendorAgreementForm initialData={agreement} onSubmit={handleSubmit} onSaveDraft={handleSubmit} submitLabel={`Save as v${agreement.version + 1}`} isEditing agreementId={agreement.id} /> : missing ? (
