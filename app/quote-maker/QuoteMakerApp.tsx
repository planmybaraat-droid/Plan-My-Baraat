...
export default function QuoteMakerApp() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#fcfbf9] pb-16 print:hidden">
      ...
      <div id="quote-maker-print-area" className="p-0 font-serif text-[#1c1917]">
        ...
        <table className="mb-6 w-full border-collapse">
          <tbody>
            <tr>
              <td className="w-1/3 border-b border-stone-100 py-2 text-[10px] font-bold uppercase tracking-wide text-stone-500"><User size={11} className="mr-1 inline" />Client name</td>
              <td className="border-b border-stone-100 py-2 text-sm font-semibold">{clientName || '—'}</td>
            </tr>
            <tr>
              <td className="border-b border-stone-100 py-2 text-[10px] font-bold uppercase tracking-wide text-stone-500"><CalendarDays size={11} className="mr-1 inline" />Event date</td>
              <td className="border-b border-stone-100 py-2 text-sm font-semibold">{niceDate || '—'}</td>
            </tr>
            <tr>
              <td className="py-2 text-[10px] font-bold uppercase tracking-wide text-stone-500"><Phone size={11} className="mr-1 inline" />Client number</td>
              ...
              {selectedServices.map(name => (
                <tr key={name}>
                  <td className="border-b border-stone-100 py-2 text-sm">
                    <Check size={13} className="mr-2 inline text-[#7C1C2B]" />
                    {name}
